# This .py file was directly lifted from https://gist.github.com/sidewinder42/8631794
# I have changed nothing.
# I am not clear on how to call this routine from within the RMG_Observations.py file. Clearly the module can be 
# imported in the regular way, but I'm not clear on how to make the sync routine rather than user initiated etc. 
